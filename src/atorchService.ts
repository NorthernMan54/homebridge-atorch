...
import { atorchPlatform } from './platform';

import createDebug from 'debug';
const debug = createDebug('ATorch:sensor');
...
export class atorchService {
  ...
  constructor(
    private readonly platform: atorchPlatform,
    ...
    switch (accessory.context.device[this.uniq_id].dev_cla) {
      ...
      case undefined:
        ...
        break;
      default:
        this.platform.log.warn('Warning: Unhandled ATorch sensor type', accessory.context.device[this.uniq_id].dev_cla);
    }
  ...
  /**
   * Handle "LWT" Last Will and Testament messages from ATorch
...
{
  name: 'Scanner status',
  stat_t: 'tele/atorch_00705C/HASS_STATE',
  avty_t: 'tele/atorch_00705C/LWT',
  pl_avail: 'Online',
  pl_not_avail: 'Offline',
  json_attr_t: 'tele/atorch_00705C/HASS_STATE',
  unit_of_meas: '%',
